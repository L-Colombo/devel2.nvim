...
local ts = {
    ...
    -- custom
    -- LaTeX
    ["@function.latex"]            = { fg = c.magenta },
    ["@function.macro.latex"]      = { fg = c.magenta, bold = true },
    ["@punctuation.bracket.latex"] = { fg = c.magenta, bold = true },
    ["@markup.italic.latex"]       = { fg = c.brown, italic = true },
    ["@markup.link.latex"]         = { fg = c.blue },
